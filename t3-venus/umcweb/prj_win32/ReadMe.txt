========================================================================
		ActiveX Control DLL : UMCWEBPROJ
========================================================================

ControlWizard has created this project for your UMCWEBPROJ ActiveX Control
...
that make up your UMCWEBPROJ ActiveX Control DLL.
...
UmcWebProjCtl.h
	This file contains the declaration of the CUmcWebProjCtrl C++ class.

UmcWebProjCtl.cpp
	This file contains the implementation of the CUmcWebProjCtrl C++ class.

UmcWebProjPpg.h
	This file contains the declaration of the CUmcWebProjPropPage C++ class.

UmcWebProjPpg.cpp
	This file contains the implementation of the CUmcWebProjPropPage C++ class.

UmcWebProjCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CUmcWebProjCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file UmcWebProj.rc.
