...
{    
    ...
    {           
        ...
        handle->m_pConnect = handle->m_sess.GetFtpConnection( handle->m_strIPAddress, "admin", "kedacomTP", INTERNET_DEFAULT_FTP_PORT );
		...
		PrtMsg( 0,emEventTypeCmsWindow,"\n[CSaveLog::ThreadDwonLoad]已建立连接 handle->m_pConnect:%d\n", handle->m_pConnect );
