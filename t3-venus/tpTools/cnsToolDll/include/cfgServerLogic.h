...
private:
	...
	const String m_strEdtDCIP;                  //数据会议服务器地址
	const String m_strEdtMatrixIP;              //矩阵服务器地址
	const String m_strBtnQTSwitch;				//QT开关
	const String m_strEdtQtIP;                  //量子加密服务器地址
	const String m_strEdtQtID;                  //量子加密服务器ID
	const String m_strEdtTimeSyncIP;            //时间同步服务器IP
