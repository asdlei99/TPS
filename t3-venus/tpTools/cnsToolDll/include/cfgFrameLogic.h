...
private:
	...
	*  @remarks   
	*/
	bool OnClickAudioCfg( const IArgs& args );
	/** 功能:  点击主音频配置按钮的响应事件
	*  @param[in] 
	*  @return 
	*  @remarks   
	*/
	bool OnClickMainAudioCfg( const IArgs& args );
	/** 功能:  点击演示源设置按钮的响应事件
	*  @param[in] 
	*  @return 
	*  @remarks   
	*/
	bool OnClickDemonStrationCfg( const IArgs& args );
	/** 功能:  点击图像参数配置按钮的响应事件
	*  @param[in] 
	*  @return 
	*  @remarks   
	*/
	bool OnClickAdjustImageCfg( const IArgs& args );
	/** 功能:  Table页切换窗口
	*  @param[in] 
	*  @return 
	*  @remarks   
