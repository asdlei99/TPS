...
,m_strDCamIndexBox("CentCfgCameraDlg/DCamIndexCombobox")
...
void CCentCfgCameraDlg::RegCBFun()
{
	...
	REG_GOBAL_MEMBER_FUNC( "CCentCfgCameraDlg::OnDocCamIndexChange", CCentCfgCameraDlg::OnDocCamIndexChange, m_pThis, CCentCfgCameraDlg );
...
//	REG_MSG_HANDLER( UI_CNSTOOL_PanCam_Nty, CCentCfgCameraDlg::OnPanCamNty, m_pThis, CCentCfgCameraDlg );
	...
	//更新文档摄像机选中项
	REG_MSG_HANDLER( UI_CNS_DCAMSELECTED_IND, CCentCfgCameraDlg::OnDCamSelectedInd, m_pThis, CCentCfgCameraDlg );
...
LRESULT CCentCfgCameraDlg::OnDcCamExpMode( WPARAM wParam, LPARAM lParam )
{
	...
	{
		LIBDATAMGRPTR->GetDCamState(m_tDCamInfo, m_byDCamSelIndex);
	}
...
LRESULT CCentCfgCameraDlg::OnDocCamInfoNty( WPARAM wParam, LPARAM lParam )
{
	...
	LIBDATAMGRPTR->GetDCamState(tDCamCfg, m_byDCamSelIndex);
...
LRESULT CCentCfgCameraDlg::OnDCamSelectedInd( WPARAM wParam, LPARAM lParam )
{
...
{
	BOOL bSave = TRUE;
	CMsgDispatch::SendMessage( UI_CNSTOOL_DCCAMERA_PreSet_Nty, (WPARAM)&bSave,NULL);
