...
u16 CCnclibCommonIF::SetDCamSelectIndex( u8 byIndex )
{
	u16 re = CNCSESSION_MGR_PTR->GetCenterCtrlIF()->SetDCamSelectIndex( byIndex );
	return re;
}

//¾ØÕó
u16 CCnclibCommonIF::SetMatrixConfig( TTPMatrixConfig tTPMatrixConfig )
{
