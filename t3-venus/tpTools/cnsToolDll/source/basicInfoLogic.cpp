...
HRESULT CBasicInfoLogic::OnConfStateNty( WPARAM wparam, LPARAM lparam)
{
	...
	{	
		...
		{
			//会议名字
			UIFACTORYMGR_PTR->SetCaption( m_strStcConfSName, tTPCnsConfStatus.achConfName, m_pWndTree);	
		}
...
HRESULT CBasicInfoLogic::OnVerInfoNty( WPARAM wparam, LPARAM lparam )
{
	...
	UIFACTORYMGR_PTR->SetCaption( "StcSoftWareDes", chVerInfo, m_pWndTree, true);
