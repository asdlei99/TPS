...
//	CCfgMixLogic::GetSingletonPtr()->InitLogic();
	...
	CCentCfgMatrix::GetSingletonPtr()->InitLogic();
	CCentCfgSrceen::GetSingletonPtr()->InitLogic();
}
...
//	CCfgMixLogic::GetSingletonPtr()->Clear();
	...
	CCentCfgMatrix::GetSingletonPtr()->Clear();
	CCentCfgSrceen::GetSingletonPtr()->Clear();
}
