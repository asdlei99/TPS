...
CCncCenterCtrl::CCncCenterCtrl(CCnsSession &cSession):CCncCenterCtrlIF()
{
    ...
    strcpy( m_tCenDFScreenInfo.tCenDownOrFlipScreenCfg[0].achGroupName, "组1");
    m_tCenDFScreenInfo.tCenDownOrFlipScreenCfg[0].emAddrCode = emAddrCode_01;
    strcpy( m_tCenDFScreenInfo.tCenDownOrFlipScreenCfg[1].achGroupName, "组2");
    m_tCenDFScreenInfo.tCenDownOrFlipScreenCfg[1].emAddrCode = emAddrCode_02;
    strcpy( m_tCenDFScreenInfo.tCenDownOrFlipScreenCfg[2].achGroupName, "组3");
