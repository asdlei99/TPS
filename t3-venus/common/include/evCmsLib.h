...
#define UI_DelROUTE_Ind  ev_UItppDelRouteInd
	...
	lparam = 0*/
	/************************************************************************/
	ev_UIMatrixConfigNty,
#define UI_MATRIXCONFIG_NTY  ev_UIMatrixConfigNty
...
#define UI_MODIFYDFSCREENCONFIG_IND  ev_UIModifyDFScreenConfigInd
	...
	lparam = 0*/
	/************************************************************************/
	ev_UIModifyDFScreenGroupInd,
#define UI_MODIFYDFSCREENGROUP_IND  ev_UIModifyDFScreenGroupInd
};
//* @}*/
#endif 
