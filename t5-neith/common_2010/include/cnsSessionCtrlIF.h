...
/*	virtual u16 CncGetInterface(CCncNetMngCtrlIF **ppCtrl) = 0;*/
	...
	virtual u16 ConnectCns(u32 dwIP, u32 dwPort,
		LPSTR strUser,
		LPSTR strPwd, BOOL32 bConnect = TRUE) = 0;
    //重载 用于IPV6登录
	...
	//获得tpad登录信息
    virtual CLoginRequest GetTpadLoginInfo() = 0;
    /** 功能  连接到TPad
	...
	/** 功能 cnc点击退出，通知TPad不再重连
	*  @remarks 
	*/
	virtual u16 NotifyTPadNoReconnect() = 0;
	 /** 功能  获取输出次数
	 *  @param[in] 
	 *  @return  
	 *  @remarks 
