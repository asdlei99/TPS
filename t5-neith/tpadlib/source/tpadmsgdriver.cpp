...
void CTPadMsgDriver::MappingEventName()
{
    ...
    MAPPING_HELPER( ev_tppCodecEncryptKey_Nty, _T("ev_tppCodecEncryptKey_Nty") );    
    ...
    //白板会议消息注册
    MAPPING_HELPER( ev_tpp_DSIPAddr_Nty, _T("ev_tpp_DSIPAddr_Nty") );
//    MAPPING_HELPER( ev_tpp_NewConfCall_Rsp, _T("ev_tpp_NewConfCall_Rsp") ); 
    MAPPING_HELPER( ev_tpp_JoinWBConf_Cmd, _T("ev_tpp_JoinWBConf_Cmd") ); 
    MAPPING_HELPER( ev_tpp_LeaveWBConf_Nty, _T("ev_tpp_LeaveWBConf_Nty") ); 
    ...
    MAPPING_HELPER( ev_tpp_DataConfName_Nty, _T("ev_tpp_DataConfName_Nty") ); 
    MAPPING_HELPER( ev_tppDataConfState_Nty, _T("ev_tppDataConfState_Nty") ); 
	...
	MAPPING_HELPER( ev_CnUpdateSystemType_Nty, _T("ev_CnUpdateSystemType_Nty") );  
	MAPPING_HELPER( ev_TpsT300Update_Ind, _T("ev_TpsT300Update_Ind") );
