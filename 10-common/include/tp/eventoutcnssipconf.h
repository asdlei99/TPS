...
*  cnc	  <- cns
*/
_event(  ev_CnManuProductID_Nty )
_body ( TTPKedaManuProductTP  , 1  )
_ev_end
...
*  cncall	  --> cns
*/
_event(  ev_CnCheckPeerIsKedaMT_Nty )
_body ( BOOL32  , 1  )
_ev_end
...
*  cncall	  <- cns
*/
_event(  ev_CnOnline_Nty )
_body ( BOOL  , 1  )
_ev_end

/***********************<<  通知CN 模板会议需要密码  >>********************	
*[消息体]
+TConfGetTempPwdReq 会议地址信息
*[消息方向]
*  cncall	 -> cns
*  cns       -> cnc
*/
_event(  ev_CnGetTempPwd_Cmd )
_body ( TTPConfGetTempPwdReq  , 1  )
_ev_end
...
*[消息方向]
*  cns       <- cnc
*/_event(  ev_CnGetTempPwd_Ind )
  _body ( s8  , MT_MAX_TEMP_PWD_LEN + 1  )
  _ev_end
