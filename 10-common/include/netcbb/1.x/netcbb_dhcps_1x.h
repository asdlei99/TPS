#ifndef _NETCBB_DHCPS_1X_H_
#define _NETCBB_DHCPS_1X_H_
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */
...
typedef struct{
	TDhcpsMacIp dhcps_mac_ip[MAX_DHCPS_NUMBER]; /*存放IP，Mac*/
	u32 dhcps_index; /*统计的数目*/
}TNetDhcpsNotify;
/************************************************************
