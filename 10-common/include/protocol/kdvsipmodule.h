...
#define SIPSERVPRINT_BUFFERSIZE				1024             ///< sipservice print buffer size
...
typedef struct tagSipModuleCfg
{
	...
	u16	       m_wCallingPort;		            ///< 呼叫端口ipv4 default 5060
...
{
	emModuleType m_emSipModule;              ///< sipmodule type
	s32 m_nLevel;                            ///< log level
